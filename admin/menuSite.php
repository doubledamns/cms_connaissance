    ...
    <div class="p-4 sm:ml-64">
        <section id="menus">
            ...
            <div class="sm:col-span-3 shadow-lg p-4 rounded-lg w-fit mt-6">
                ...
                <div class="mt-2">
                    <select name="menuType" id="menuType" class="block w-56 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-purple-300 sm:text-sm sm:leading-6">
                    <option></option>
                    </select>
                </div>
            </div>
