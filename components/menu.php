<div class="relative w-full top-0 bg-white mx-auto px-6">
    <div class="flex justify-between items-center py-2 lg:space-x-10">
        ...
        <nav class="hidden space-x-10 lg:flex items-center">
            ...
            <a href="#contact" class="ml-8 inline-flex items-center justify-end whitespace-nowrap rounded-md border border-transparent bg-purple-200 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-purple-100">Contactez-nous</a>
        </nav>
        <div class="menu-desktop-btn flex items-center justify-end lg:hidden">
            <a onclick="doMenu()" class="ml-8 inline-flex items-center justify-center whitespace-nowrap rounded-md border border-transparent bg-purple-200 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-purple-100 cursor-pointer">
        ...
        <div class="divide-y-2 divide-gray-50 rounded-lg bg-white shadow-lg ring-1 ring-black ring-opacity-5 w-full">
            ...
            <div class="menu-mobile-content space-y-6 py-6 px-5">
                ...
                <div class="menu-mobile-container">
                    <a href="#contact" class="menu-mobile-btn flex w-full items-center justify-center rounded-md border border-transparent bg-purple-200 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-purple-100">Nous
                        contacter</a>
                </div>
            </div>
        </div>
